  ...
  return (
    <div className="instructors-container">
      ...
      <p className="instructors-intro">
        Meet our expert facilitators who design and guide RCVD e-Learning
        courses. Our instructors bring real-world veterinary expertise to
        ...
        {instructors.map((inst) => (
          <div key={inst.id} className="instructor-card">
            <div className="instructor-avatar">
              ...
              <a href={`/instructor/${inst.id}`} className="link">
                Details
              </a>
            </div>
          </div>
